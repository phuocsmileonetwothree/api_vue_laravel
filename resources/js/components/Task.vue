    ...
    methods: {
        ...
        deleteTask(index) {
            ...
            if (conf === true) {
                ...
                axios.delete('/Project/api/task/' + this.tasks[index].id)
        ...
        readTasks() {
            ...
            axios.get('/Project/api/task/'+ this.tasks[index].id)
        ...
        updateTask() {
            ...
            axios.patch('/Project/api/task/' + this.update_task.id, {
